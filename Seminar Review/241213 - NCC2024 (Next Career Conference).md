...
- **팀워크 구축 비밀 15가지**
	1. **상호신뢰** : 전체 팀워크에서 가장 중요한 근본적인 요소. 두 가지 관점으로 생각하면 된다. 어떻게 말해야 오해하지 않을 것인가, 어떻게 들어야 오해하지 않을 것인가. 말한 내용을 곧이 곧대로 듣지 않아서 문제가 생기는 경우가 많다. (피드백에서 많이 발생) 피드백을 공격으로 받는 경우가 있다. 나를 공격하는 의도가 아니라, 내 아이디어를 더욱 발전시키기 위한 신호라고 생각하게 되는 것이 중요하다. (신뢰의 근간) 이것이 없으면 온전한 피드백을 할 수 없게 된다. **세상에 바보같은 질문은 없다.** 